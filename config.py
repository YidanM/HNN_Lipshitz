...
config_args = {
    'training_config': {
        ...
        'noise_std': (0.001, 'standard deviation of Gaussian noise adding to input node features'),
        'multiplier': (1e-5, 'multiplier for the regularization term'),
        'lip': (0, '0 for lipsum1 and 1 for lipsum2'),
        'noise_in_training': (0, 'whether to add repetitive noise perturbations during the training, 0 False')
    },
